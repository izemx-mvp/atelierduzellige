...
function FollowUpPage() {
  ...
  const link = (f: FollowUp) => f.targetType === "quote" ? `/devis/${f.targetId}` : f.targetType === "order" ? `/commandes/${f.targetId}` : f.targetType === "client" ? `/clients/${f.targetId}` : f.targetType === "sample" ? "/echantillons" : f.targetType === "appointment" ? "/agents/booking" : `/prospects/${f.targetId}`;
